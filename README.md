...
sequenceDiagram
    ...
    User->>Webview: 1. เปิดเว็บฟอร์ม & รับทราบขอบเขต กทม. (Step 1)
    User->>Webview: 2. ค้นหา แขวง/เขต และกรอกที่อยู่บ้านพัก (Step 6)
    User->>Webview: 3. ปักหมุดพิกัดบ้านพักจริงของผู้ป่วยบนแผนที่ (Step 7)
    ...
    Nurse->>DB: 9. ประเมิน ADL 10 ข้อ, บัตรคนพิการ ➔ INSERT into in_home_assessments
...
| **รหัสศูนย์บริการสาธารณสุข (ศบส. 69 แห่ง)** | **Backend System** ⚙️ | ประชาชนไม่ทราบรหัส ศบส. **ระบบใช้ที่อยู่ กทม. (ข้อ 6) + พิกัดบ้านพัก (ข้อ 7)** ไปค้นหารหัส ศบส. ที่รับผิดชอบให้อัตโนมัติ |
...
| :--- | :---: | :--- |
| สถานะผู้ยื่นเรื่อง + แจ้งเตือนพื้นที่ กทม. | **คำถามที่ 1** | กำหนดบริบทการกรอกข้อมูล + แจ้งเตือนสิทธิเฉพาะ กทม. พร้อมปุ่มรับทราบ |
| ชื่อ - นามสกุล ผู้ป่วย | **คำถามที่ 2** | ระบุตัวตนผู้ป่วยผู้ขอรับสิทธิ |
...
| แนบรูปถ่ายใบรับรองแพทย์ | **คำถามที่ 5 (Conditional Step)** ✨ | **แสดงเฉพาะผู้ที่เลือก "กลั้นไม่ได้" ในข้อ 4** *(ข้ามไปข้อ 6 ให้อัตโนมัติหากติดเตียง)* |
| ที่อยู่ / แขวง / เขต / จุดสังเกต | **คำถามที่ 6** | **BKK Address Autocomplete:** ค้นหา แขวง/เขต 50 เขต 180 แขวง + จุดสังเกต |
| พิกัดบ้านพักอาศัยของผู้ป่วย (ปักหมุด) | **คำถามที่ 7** | **Patient Home Coordinates:** แผนที่ Leaflet พร้อมคำแนะนำ 3 ขั้นตอน ชี้แจงชัดเจนว่าเป็นพิกัดบ้านพักผู้ป่วย |
...
| สรุปข้อมูลการยื่นเรื่อง | **ขั้นตอนสุดท้าย (11)** | แสดงสรุป 5 การ์ดหมวดหมู่ พร้อมปุ่มแยกแก้ไขที่อยู่ / แก้ไขพิกัด |

---

## ✨ จุดเด่นและฟีเจอร์หลัก (Key Features)

1. **BKK Address Autocomplete (เชื่อมโยงฐานข้อมูล กทม. ครบ 100%):**
   - ฐานข้อมูล แขวง และ เขต ครบถ้วนสมบูรณ์ทั้ง **50 เขต 180 แขวง** ของกรุงเทพมหานคร ซิงค์ตรงกับตารางฐานข้อมูล `public.voice_subdistrictlist` พร้อมรหัสไปรษณีย์ที่ถูกต้อง
   - สามารถพิมพ์หรือเลือกตัวเลือก **แขวง / เขต / รหัสไปรษณีย์** ได้ทันทีเมื่อแตะช่องค้นหา ป้องกันการพิมพ์ชื่อแขวง/เขตผิด 100%
2. **Interactive Patient Home Map Pinning:**
   - ปักหมุดพิกัดบ้านพักจริงของผู้ป่วยบนแผนที่ Leaflet พร้อมคำแนะนำการใช้งาน 3 ขั้นตอน และชี้แจงชัดเจนว่าระบุพิกัดบ้านพักเพื่อการเยี่ยมบ้าน ไม่ใช่พิกัดของโทรศัพท์มือถือที่กำลังกรอก
...
4. **โครงสร้างคำถามเรียงตามหลักจิตวิทยา UX/UI (Progressive Disclosure):**
   - เรียงคำถามจาก บริบทและแจ้งสิทธิ ➔ ข้อมูลตัวตน ➔ สิทธิทางการแพทย์ ➔ ที่อยู่ กทม. ➔ ปักหมุดบ้านพัก ➔ ข้อมูลติดต่อ ➔ สรุปการยื่นเรื่อง
...
* **เลือกที่อยู่ กทม. (Address Autocomplete Step 6):** ค้นหา แขวง และ เขต ในกรุงเทพฯ (รองรับครบถ้วนทั้ง 50 เขต 180 แขวง)
* **ระบุพิกัดบ้านพักผู้ป่วย (Patient Home Map Pin Step 7):** ปักหมุดพิกัดบ้านพักจริงของผู้ป่วยบนแผนที่ Leaflet พร้อมคำแนะนำ 3 ขั้นตอน
* **เลือกสภาวะสุขภาพผู้ป่วย (Condition Selection Trigger):** หากเลือก "กลั้นไม่ได้" ระบบเปิดช่องแนบใบรับรองแพทย์ให้อัตโนมัติ หากเลือก "ติดเตียง" ระบบข้ามไปข้อ 6 (ที่อยู่) ให้อัตโนมัติ
...
* **ยื่นเรื่องสำเร็จ (Completion Trigger):** แสดงหน้าสำเร็จเต็มจอ (Step 12 Success Page) แจ้งสรุปและคืบหน้าทางแชต LINE

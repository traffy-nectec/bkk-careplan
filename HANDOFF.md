...
* **ยื่นเรื่องสำเร็จ (Completion Trigger):** แสดงป๊อปอัปยืนยันการยื่นเรื่องเรียบร้อยแล้ว (ซ่อนการแสดงผล raw JSON Payload ออกจากหน้าจอผู้ใช้) และแจ้งผู้ใช้เรื่องการรับใบรวบรวมสรุปกับความคืบหน้าทางแชต LINE
...
sequenceDiagram
    ...
    LIFF-->>User: 9. แสดงผลป๊อปอัป "✅ ยื่นเรื่องเรียบร้อยแล้ว" (ส่ง JSON ไป Gateway และซ่อน JSON จากผู้ใช้)

...
* **เน้นย้ำ:** ข้อมูลตัวตน (ชื่อ-เลขบัตร 13 หลัก), สภาวะเดือดร้อน, รูปถ่ายใบรับรองแพทย์ (กรณีกลั้นไม่ได้), สถานที่ (GPS + ที่อยู่ กทม. พร้อมระบบ Autocomplete ครบถ้วนทั้ง 50 เขต 180 แขวง ซิงค์กับ `public.voice_subdistrictlist`), เบอร์ติดต่อนัดหมาย และผู้ดูแล

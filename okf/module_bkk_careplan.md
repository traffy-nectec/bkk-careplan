...
| 7 | `patient_address` | ที่อยู่ กทม. + จุดสังเกต | Autocomplete & Text | Required | **BKK Address Autocomplete** (ครบ 50 เขต 180 แขวง ซิงค์กับ `public.voice_subdistrictlist`) + ช่องจุดสังเกต |

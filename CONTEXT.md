...
1. **One-Question-Per-Screen & Address-First Pinning (Conversational Wizard UI)**:
   - ออกแบบแบบ Mobile-First เพื่ออำนวยความสะดวกให้ผู้สูงอายุหรือผู้ดูแลกรอกผ่านสมาร์ทโฟน (10 ข้อคำถาม / 11 ขั้นตอน)
   - **ข้อ 1 แจ้งเตือนขอบเขตพื้นที่ กทม.** ชัดเจนพร้อมปุ่มรับทราบและดำเนินการต่อ โดยไม่ต้องติด Pop-up ขอพิกัดตั้งแต่เปิดหน้า
   - **ข้อ 6 กรอกที่อยู่ กทม.** ด้วยระบบค้นหา แขวง/เขต ครอบคลุม 50 เขต 180 แขวง
   - **ข้อ 7 ปักหมุดพิกัดบ้านพักผู้ป่วย** บนแผนที่ Leaflet พร้อมคำแนะนำ 3 ขั้นตอน ชี้แจงชัดเจนว่าเป็นพิกัดบ้านพักจริงของผู้ป่วย
...
4. **Complete BKK Address Dataset (50 Districts & 180 Subdistricts)**:
   - ฐานข้อมูล แขวง และ เขต ในระบบ Autocomplete ครอบคลุม 100% ทั้ง **50 เขต 180 แขวง** ของกรุงเทพมหานคร เชื่อมโยงและสะกดตรงกับตาราง `public.voice_subdistrictlist` ในฐานข้อมูล Cloud SQL
5. **JSON Payload Standard**:
